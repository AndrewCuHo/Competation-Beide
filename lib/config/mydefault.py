...
# ----- DATASET BUILDER -----
_C.DATASET = CN()
_C.DATASET.DATASET = "IMBALANCECASSAVA"
# _C.DATASET.ROOT = "/home/cassava/data"
_C.DATASET.DATA_TYPE = "jpg"
_C.DATASET.TRAIN_JSON = ""
_C.DATASET.VALID_JSON = ""
_C.DATASET.IMBALANCECASSAVA = CN()
_C.DATASET.IMBALANCECASSAVA.RATIO = 0.01
_C.DATASET.IMBALANCECASSAVA.RANDOM_SEED = 2020

# ----- BACKBONE BUILDER -----
_C.BACKBONE = CN()
_C.BACKBONE.TYPE = "res50"
_C.BACKBONE.FREEZE = False
_C.BACKBONE.PRETRAINED_MODEL = "./best_model.pth"
...
_C.LOSS.CSCE.DRW_EPOCH = 80

_C.LOSS.LDAM = CN()
_C.LOSS.LDAM.DRW_EPOCH = 80
