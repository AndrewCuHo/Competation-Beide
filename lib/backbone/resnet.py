...
class BBN_ResNextNet(nn.Module):
    def __init__(self, block, layers, num_classes=5, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,in_planes=9,
                 norm_layer=None):
        ...
        self.conv1 = nn.Conv2d(in_planes, self.inplanes, kernel_size=7, stride=2, padding=3,
                               bias=False)
...
def _resnext(arch, cfg, test, block, layers, pretrained=False, progress=None, **kwargs):
